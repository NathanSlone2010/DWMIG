...
if name == "DEV":
    ...
    print("\n All options: zones [z], operations [o], archetypes [a], sites [s], security [se], version [v], history [h], documentation [d], Resources [rs], donations [do], developer [de], developer recommendations [dr], exit")
else:
    print("Welcome, " + name)
    print("\n All options: zones [z], operations [o], archetypes [a], sites [s], security [se], version [v], history [h], documentation [d], Resources [rs], donations [do], recommendations [r], exit")
