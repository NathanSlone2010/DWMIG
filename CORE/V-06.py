...
print("\n ALL OPTIONS: ZONES [Z], OPERATIONS [O], ARCHTYPES [A], SITES [S], VERSION [V], HISTORY [H], DOCUMENATION [D], RESOURCES [RS], DEVELOPER [DR], RECOMMENDATIONS [R], EXIT")
