...
while True:
    ...
    if document == "exit":
        ...
        print("2.0.1: Shortened down the bloat of the system a teeny bit | 2.1.1: Cut down the bloat even more, probably made it harder to read the code though | 3.2.1: Cut down bloat. Ability to read fhe code nust went skyrocketing down [even cut out soem history].")
     elif document == "rs":
